...
namespace CardFilePBX
{
    class DatabaseApplication
    {
        ...
        public void AddAbonent(int id, string first_name, string last_name, string patronymic, string phone_number)
        {
            ...
            {
                command.Parameters.Add("@first_name", SqlDbType.NVarChar, 16).Value = first_name;
                command.Parameters.Add("@last_name", SqlDbType.NVarChar, 16).Value = last_name;
                command.Parameters.Add("@patronymic", SqlDbType.NVarChar, 16).Value = patronymic;
